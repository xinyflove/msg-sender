...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("/packages/msg-sender/MsgSenderLTE/dist/css/main.css") }}">
    <script src='https://cdn.bootcss.com/socket.io/2.0.3/socket.io.js'></script>
    <script src='//cdn.bootcss.com/jquery/1.11.3/jquery.js'></script>
    <script src="{{ asset ("/packages/msg-sender/MsgSenderLTE/dist/js/notify.js") }}"></script>
</head>
<style>
    body {
        background:url({{ asset ("/packages/msg-sender/MsgSenderLTE/dist/img/repeat.jpg") }});
    }
</style>
<body>
...
<div class="notification sticky hide">
    <p id="content"> </p>
    <a class="close" href="javascript:"> <img src="{{ asset ("/packages/msg-sender/MsgSenderLTE/dist/img/icon-close.png") }}" /></a>
</div>
<div class="wrapper">
